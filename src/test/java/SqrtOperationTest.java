...
public class SqrtOperationTest {
    ...
    public void sqrtWithNegativeNumber() throws IllegalArgumentException {
        SqrtOperation sqrtOperation = new SqrtOperation();
        sqrtOperation.sqrt(NEGATIVE_NUMBER);
    }

    @Test
    public void sqrtWithPositiveNumber() throws IllegalArgumentException {
        SqrtOperation sqrtOperation = new SqrtOperation();
    ...
    @Test
    public void sqrtWithZeroNumber() throws IllegalArgumentException {
        SqrtOperation sqrtOperation = new SqrtOperation();
